...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-create/scripts/db-create.py" <параметры>
```
...
bash tools/sandbox/run.sh python ".cursor/skills/db-create/scripts/db-create.py" -InfoBasePath "C:\Bases\NewDB"

# Создать серверную базу
bash tools/sandbox/run.sh python ".cursor/skills/db-create/scripts/db-create.py" -InfoBaseServer "srv01" -InfoBaseRef "MyApp_Test"

# Создать из шаблона CF
bash tools/sandbox/run.sh python ".cursor/skills/db-create/scripts/db-create.py" -InfoBasePath "C:\Bases\NewDB" -UseTemplate "C:\Templates\config.cf"

# Создать и добавить в список баз
bash tools/sandbox/run.sh python ".cursor/skills/db-create/scripts/db-create.py" -InfoBasePath "C:\Bases\NewDB" -AddToList -ListName "Новая база"
```
