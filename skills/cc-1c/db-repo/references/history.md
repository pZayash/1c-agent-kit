...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-repo/scripts/db-repo.py" -Command report -InfoBasePath "C:\Bases\MyDB" -OutputFile "C:\tmp\repo.txt"
```
...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-repo/scripts/db-repo.py" -Command dump-cfg -InfoBasePath "C:\Bases\MyDB" -OutputFile "C:\tmp\v120.cf" -Version 120
```
