...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-repo/scripts/db-repo.py" -Command create -InfoBasePath "C:\Bases\MyDB" -RepositoryPath "C:\Repo\MyApp" -RepositoryUser "Admin" -RepositoryPassword "…"
```
...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-repo/scripts/db-repo.py" -Command add-user -InfoBasePath "C:\Bases\MyDB" -NewUser "Ivanov" -NewUserPassword "…" -Rights LockObjects
```
...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/db-repo/scripts/db-repo.py" -Command copy-users -InfoBasePath "C:\Bases\MyDB" -SourcePath "\\srv01\repo\Other" -SourceUser "Admin" -SourcePassword "…"
```
