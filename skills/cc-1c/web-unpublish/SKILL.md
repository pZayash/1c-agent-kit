...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" <параметры>
```
...
bash tools/sandbox/run.sh python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -AppName "bpdemo"

# Удалить все публикации
bash tools/sandbox/run.sh python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -All

# С указанием пути
bash tools/sandbox/run.sh python ".cursor/skills/web-unpublish/scripts/web-unpublish.py" -AppName "mydb" -ApachePath "C:\tools\apache24"
```
