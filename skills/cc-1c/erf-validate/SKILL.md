...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт"
bash tools/sandbox/run.sh python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
