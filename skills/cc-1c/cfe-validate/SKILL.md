...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname"
bash tools/sandbox/run.sh python ".cursor/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname\Configuration.xml"
bash tools/sandbox/run.sh python ".cursor/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname" -ConfigPath "src\cf"
```
