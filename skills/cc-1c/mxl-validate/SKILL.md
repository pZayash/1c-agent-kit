...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/mxl-validate/scripts/mxl-validate.py" -TemplatePath "Catalogs/Номенклатура/Templates/Макет"
bash tools/sandbox/run.sh python ".cursor/skills/mxl-validate/scripts/mxl-validate.py" -TemplatePath "src/МояОбработка/Templates/ПечатнаяФорма"
```
