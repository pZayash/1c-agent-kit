...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/interface-validate/scripts/interface-validate.py" -CIPath "Subsystems/Продажи"
bash tools/sandbox/run.sh python ".cursor/skills/interface-validate/scripts/interface-validate.py" -CIPath "Subsystems/Продажи/Ext/CommandInterface.xml"
```
