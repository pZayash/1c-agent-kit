...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка"
bash tools/sandbox/run.sh python ".cursor/skills/epf-validate/scripts/epf-validate.py" -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
