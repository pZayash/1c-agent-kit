...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/form-validate/scripts/form-validate.py" -FormPath "Catalogs/Номенклатура/Forms/ФормаЭлемента"
bash tools/sandbox/run.sh python ".cursor/skills/form-validate/scripts/form-validate.py" -FormPath "src/МояОбработка/Forms/Форма/Ext/Form.xml"
```
