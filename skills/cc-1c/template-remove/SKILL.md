...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/template-remove/scripts/remove-template.py" -ObjectName "<ObjectName>" -TemplateName "<TemplateName>" [-SrcDir "<SrcDir>"]
```
