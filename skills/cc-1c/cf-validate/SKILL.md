...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty"
bash tools/sandbox/run.sh python ".cursor/skills/cf-validate/scripts/cf-validate.py" -ConfigPath "upload/cfempty/Configuration.xml"
```
