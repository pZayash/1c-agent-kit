...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/web-stop/scripts/web-stop.py" <параметры>
```
...
```bash
# Остановить Apache
bash tools/sandbox/run.sh python ".cursor/skills/web-stop/scripts/web-stop.py"

# С указанием пути
bash tools/sandbox/run.sh python ".cursor/skills/web-stop/scripts/web-stop.py" -ApachePath "C:\tools\apache24"
```
