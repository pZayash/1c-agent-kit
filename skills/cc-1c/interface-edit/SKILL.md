...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/interface-edit/scripts/interface-edit.py" -CIPath '<path>' -Operation hide -Value '<cmd>'
```

### JSON mode

```bash
bash tools/sandbox/run.sh python ".cursor/skills/interface-edit/scripts/interface-edit.py" -CIPath '<path>' -DefinitionFile '<json>'
```
