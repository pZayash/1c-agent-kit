...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/skd-validate/scripts/skd-validate.py" -TemplatePath "src/МойОтчёт/Templates/ОсновнаяСхема"
bash tools/sandbox/run.sh python ".cursor/skills/skd-validate/scripts/skd-validate.py" -TemplatePath "Catalogs/Номенклатура/Templates/СКД/Ext/Template.xml"
```
