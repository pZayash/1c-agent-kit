...
```bash
bash tools/sandbox/run.sh python ".cursor/skills/meta-validate/scripts/meta-validate.py" -ObjectPath "Catalogs/Номенклатура/Номенклатура.xml"
bash tools/sandbox/run.sh python ".cursor/skills/meta-validate/scripts/meta-validate.py" -ObjectPath "Catalogs/Банки|Documents/Заказ"
```
